        ...
        <div className="bg-brand-light">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 flex items-center justify-center min-h-[60vh]">
                <div className="text-center bg-white p-12 rounded-lg shadow-xl max-w-md w-full">
                    <h1 className="text-3xl font-extrabold text-brand-primary">Student Portal</h1>
                    <p className="text-gray-600 mt-4 mb-6">Access your courses, grades, and university resources.</p>
                    
                    <form className="space-y-4">
                         <div>
                            <label className="sr-only">Email</label>
                            <input type="email" placeholder="Student Email" className="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-brand-secondary focus:border-brand-secondary transition" />
                        </div>
                         <div>
